...
var ApplyFlags = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(ApplyFlags, _AbstractMethod);

  function ApplyFlags(message) {
    var _this;
  ...
  var _proto = ApplyFlags.prototype;
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.device.getCommands().applyFlags(this.params);
