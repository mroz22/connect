...
var TezosGetPublicKey = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(TezosGetPublicKey, _AbstractMethod);
  ...
  function TezosGetPublicKey(message) {
    ...
    _this.info = 'Export Tezos public key'; // create a bundle with only one batch if bundle doesn't exists
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (this.params.length > 1) {
                ...
                label = "Export Tezos public key for account #" + ((0, _pathUtils.fromHardened)(this.params[0].path[2]) + 1);
