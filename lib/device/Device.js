...
var Device = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Device(transport, descriptor) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "isBitcoinOnly", false);
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              descriptor = _objectSpread({}, originalDescriptor, {
                session: null
              });
              _context.prev = 1;
      ...
      return _regenerator["default"].wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 18:
              this.runPromise = null;
              ERROR.INITIALIZATION_FAILED.message = "Initialize failed: " + _context7.t0.message;
              return _context7.abrupt("return", Promise.reject(ERROR.INITIALIZATION_FAILED));
  ...
  _proto.validateState = /*#__PURE__*/function () {
    var _validateState = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8() {
      var expectedState, state, uniqueState;
      return _regenerator["default"].wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 2:
              expectedState = this.getExternalState();
              _context8.next = 5;
              return this.commands.getDeviceState();
  ...
  _proto.initialize = /*#__PURE__*/function () {
    var _initialize = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(useEmptyPassphrase) {
      var payload, legacy, internalState, _ref, message;
  ...
  _proto._updateFeatures = function _updateFeatures(feat) {
    feat.capabilities = (0, _deviceFeaturesUtils.parseCapabilities)(feat);
    var version = [feat.major_version, feat.minor_version, feat.patch_version]; // check if FW version did change

    if ((0, _deviceFeaturesUtils.versionCompare)(version, this.getVersion()) !== 0) {
      ...
      this.firmwareStatus = (0, _FirmwareInfo.getFirmwareStatus)(feat); // maybe not in bootloade?
  ...
  _proto.atLeast = function atLeast(versions) {
    ...
    return (0, _deviceFeaturesUtils.versionCompare)(this.getVersion(), modelVersion) >= 0;
  };
