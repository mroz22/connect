...
var LiskGetPublicKey = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function LiskGetPublicKey(message) {
    ...
    _this.info = 'Export Lisk public key'; // create a bundle with only one batch if bundle doesn't exists
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (this.params.length > 1) {
                ...
                label = "Export Lisk public key for account #" + ((0, _pathUtils.fromHardened)(this.params[0].path[2]) + 1);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              batch = this.params[i];
              _context2.next = 6;
              return this.device.getCommands().liskGetPublicKey(batch.path, batch.showOnTrezor);
