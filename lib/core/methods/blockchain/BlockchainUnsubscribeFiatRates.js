...
var BlockchainUnsubscribeFiatRates = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(BlockchainUnsubscribeFiatRates, _AbstractMethod);

  function BlockchainUnsubscribeFiatRates(message) {
    var _this;
  ...
  var _proto = BlockchainUnsubscribeFiatRates.prototype;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", backend.unsubscribeFiatRates());
  ...
  return BlockchainUnsubscribeFiatRates;
