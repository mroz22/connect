...
var BlockchainGetTransactions = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(BlockchainGetTransactions, _AbstractMethod);

  function BlockchainGetTransactions(message) {
    var _this;
  ...
  var _proto = BlockchainGetTransactions.prototype;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", backend.getTransactions(this.params.txs));
  ...
  return BlockchainGetTransactions;
