...
var BinanceGetPublicKey = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(BinanceGetPublicKey, _AbstractMethod);

  function BinanceGetPublicKey(message) {
    var _this;
    ...
    _this.info = 'Export Binance public key'; // create a bundle with only one batch if bundle doesn't exists
  ...
  var _proto = BinanceGetPublicKey.prototype;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (this.params.length > 1) {
                ...
                label = "Export Binance public key for account #" + ((0, _pathUtils.fromHardened)(this.params[0].path[2]) + 1);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              batch = this.params[i];
              _context2.next = 6;
              return this.device.getCommands().binanceGetPublicKey(batch.path, batch.showOnTrezor);
