        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 7;
              return this.device.getCommands().getAddress(batch.path, batch.coinInfo, false, batch.multisig, batch.scriptType);
            ...
            case 14:
              _context3.next = 16;
              return this.device.getCommands().getAddress(batch.path, batch.coinInfo, batch.showOnTrezor, batch.multisig, batch.scriptType);
