...
var TezosGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  (0, _inheritsLoose2["default"])(TezosGetAddress, _AbstractMethod);
  ...
  function TezosGetAddress(message) {
    ...
    _this.firmwareRange = (0, _paramsValidator.getFirmwareRange)(_this.name, (0, _CoinInfo.getMiscNetwork)('Tezos'), _this.firmwareRange); // create a bundle with only one batch if bundle doesn't exists
    ...
    if (bundle.length === 1) {
      _this.info = "Export Tezos address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].path[2]) + 1);
    } else {
