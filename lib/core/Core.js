...
var _handleMessage = function handleMessage(message, isTrustedOrigin) {
  ...
  var safeMessages = [IFRAME.CALL, POPUP.CLOSED, // UI.CHANGE_SETTINGS,
...
var onCall = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(message) {
    var responseID, trustedHost, isUsingPopup, method, messageResponse, _response, device, _response2, previousCall, PIN_TRIES, MAX_PIN_TRIES, inner, _response4;
                ...
                return _regenerator["default"].wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 10:
                        return _context2.abrupt("return", Promise.reject('Cancelled'));

                      case 13:
                        return _context2.abrupt("return", Promise.reject(firmwareException));
                      ...
                      case 23:
                        return _context2.abrupt("return", Promise.reject(unexpectedMode));
                      ...
                      case 31:
                        ...
                        return _context2.abrupt("return", Promise.reject(ERROR.PERMISSIONS_NOT_GRANTED.message));
                      ...
                      case 96:
                        ...
                        return _context2.abrupt("return", Promise.reject(_context2.t1.message));
    ...
    }, _callee3, null, [[6, 15], [22, 35], [47, 53], [66, 75], [107, 115, 118, 132]]);
  }));
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _deviceList.on(TRANSPORT.ERROR, /*#__PURE__*/function () {
            ...
            _deviceList.on(TRANSPORT.START, function (transportType) {
              return postMessage((0, _builder.TransportMessage)(TRANSPORT.START, transportType));
            });
